...
return packer.startup(function(use)
        ...
        use {
                ...
                setup = function()
                        vim.api.nvim_set_keymap('n', '<Leader>t', ':Neotree toggle<CR>',
                                { noremap = true, silent = true })
                        vim.api.nvim_set_keymap('n', '<Leader>f', ':Neotree reveal<CR>',
                                { noremap = true, silent = true })
                end,
                requires = {
        ...
        use {
                ...
                setup = function()
                        vim.api.nvim_set_keymap('n', '<Leader>bh', '<Cmd>OpenGithubFile<CR>',
                                { noremap = true, silent = true })
                        vim.api.nvim_set_keymap('x', '<Leader>bh', '<Cmd>OpenGithubFile<CR>',
                                { noremap = true, silent = true })
                end,
        }
        ...
        use {
                ...
                after = { "open-browser.vim" },
                setup = function()
                        vim.api.nvim_set_keymap('n', '<Leader>p', '<Cmd>PrevimOpen<CR>',
                                { noremap = true, silent = true })
                end,
        }
        ...
        use {
                ...
                setup = function()
                        vim.api.nvim_set_keymap('n', '<LocalLeader>b', '<Cmd>GoBuild<CR>',
                        ...
                        vim.api.nvim_set_keymap('n', '<LocalLeader>m', '<Cmd>GoImport<CR>',
                                { noremap = false, silent = true })
                        vim.api.nvim_set_keymap('n', '<LocalLeader>a', '<Cmd>GoAlt<CR>',
                                { noremap = false, silent = true })
                end,
        }
